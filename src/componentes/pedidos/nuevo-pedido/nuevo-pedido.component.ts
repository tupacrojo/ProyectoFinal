...
export class NuevoPedidoComponent {
    ...
    seleccionarProducto(index: number, checkbox: HTMLInputElement){
      ...
      if(checkbox.checked){
        ...
        if(this.productoSeleccionado != null){
          this.listaProductosPedido = this.listaProductosPedido.filter(producto => producto.id !== this.productoSeleccionado.id);
        }
    ...
    validarCantidadInicial(id: number): number | null{
      ...
      const index = this.listaProductosPedido.findIndex(producto => producto.id = id);
    ...
    eliminarDatoFormulario(){
      ...
      if(this.mostrarFormulario && this.productoSeleccionado != null){
        ...
        if(this.listaProductosPedido.some(producto => producto.id === this.productoSeleccionado.id)){
          this.listaProductosPedido = this.listaProductosPedido.filter(producto => producto.id != this.productoSeleccionado.id )
        }
    ...
    cargarArregloProductos(cantidad: number){
      ...
      if(this.productoSeleccionado != null){
        ...
        const index = this.listaProductosPedido.findIndex(producto => producto.id === this.productoSeleccionado.id)
